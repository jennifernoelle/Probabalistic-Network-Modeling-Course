...
You are encouraged to use R Markdown to type up this lab report. If you do not already know how to use R markdown, refer to the resources section at the end of this document.
...
Now provide the data, constants, and intial values for MCMC. 
...
Add the rest of the tutorial here. 
...
Rmcmc <- buildHMC(Rmodel) # if we don't supply node names, all non-data nodes will be sampled via HMC
...
This lab builds on an introductory exercise created by [Jordan Bryan](https://stat.duke.edu/people/jordan-bryan) and [Becky Tang](https://stat.duke.edu/people/becky-tang).
